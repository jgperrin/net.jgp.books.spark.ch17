...
relative_path = "../../../../data/france_grand_debat/20190302 EVENTS.json"
absolute_file_path = os.path.join(current_dir, relative_path)

# Creates a session on a local master
# To use Databricks Delta Lake, we should add delta core packages to SparkSession
spark = SparkSession.builder.appName("Ingestion the 'Grand Debate' files to Delta Lake") \
...
df.write.format("delta").mode("overwrite").save("/tmp/delta_grand_debat_events")
